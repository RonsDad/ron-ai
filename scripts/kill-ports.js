...
const PORTS = [3000, 8000, 8001]; // Frontend, Browser-use backend, Claude backend
...
async function killAllPorts() {
  console.log('🧹 Cleaning up ports before starting services...\n');
  
  for (const port of PORTS) {
    await killPort(port);
  }
  
  console.log('\n🎉 All ports cleaned up! Ready to start services.\n');
}
